...
Odoo module that turns Odoo into an OpenID Connect / OAuth2 Identity Provider. Target versions: Odoo 18/19 (Community and Enterprise). Status: **experimental**.
...
## Example: React/TypeScript App (e.g., https://example-app.test)
...
1) Create an OIDC client in Odoo:
   - client_id: `pd-web`
   - client_secret: **empty** for a public client with PKCE
